...
* ~~**Stage names.**~~ **CLOSED by patch 16.** They are on the VS button-config
  ...
  `docs/project/menu_text.md`. (Two Silver Millenniums existed when this was written;
...
> `docs/project/menu_text.md`. The account below is how it was hunted before that.
...
screen `docs/project/menu_text.md` inventories for the translation patch. The harness's
...
template `$C3:7C00`, shipped behind `SMS_P16_STAGES=1`; `docs/project/menu_text.md`).
