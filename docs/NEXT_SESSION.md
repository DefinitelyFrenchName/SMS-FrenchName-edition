...
Rev. S-01 is REF v.2 retitled and Rev. SS-01 is Saturn v0.16.1 retitled; both
diffs are patch 4's bank `$E9` plus the checksum, measured. So a reference is
never a build that has not been tested — it is a tested build under a release
name.
