...
emu.addMemoryCallback(function()
  if needLoad then local f = io.open(TRACE.."uranus_vs_jupiter_v07.mss","rb") if not f then print("probe_digit.lua: cannot open " .. (TRACE.."uranus_vs_jupiter_v07.mss")) emu.stop(1) return end
...
emu.addEventCallback(function()
  ...
  if t==40 then local f = io.open(TRACE.."cc_digit.png","wb") if not f then print("probe_digit.lua: cannot open " .. (TRACE.."cc_digit.png")) emu.stop(1) return end f:write(emu.takeScreenshot()); f:close(); emu.stop(0) end
  t=t+1
