...
local function pad(pl,t) local best={}; local bk=-1
  for k,v in pairs(pl) do if k<=t and k>bk then bk=k; best=v end end
  local o={}; for k,v in pairs(FALSE) do o[k]=v end; for k,v in pairs(best) do o[k]=v end; return o end
local P1={[10]={down=true},[60]={down=true,x=true},[63]={down=true}}
...
emu.addEventCallback(function()
  ...
  emu.setInput(pad(P2,t),0,1); emu.setInput(pad(P1,t),0,0)
