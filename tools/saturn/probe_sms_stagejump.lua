...
local STEPS = {
  ...
  function()
    ...
    if sf == 118 or sf == 145 then
      ...
      if not f then print("probe_sms_stagejump.lua: cannot open " .. (ENV.TRACE .. "saturn/stagejump_" .. TAG .. "_wram" .. sf .. ".bin")) emu.stop(1) return end
      ...
      if not vf then print("probe_sms_stagejump.lua: cannot open " .. (ENV.TRACE .. "saturn/stagejump_" .. TAG .. "_vram" .. sf .. ".bin")) emu.stop(1) return end
      ...
      if ok then
        ...
        if not g then print("probe_sms_stagejump.lua: cannot open " .. (ENV.TRACE .. "saturn/stagejump_" .. TAG .. "_oam" .. sf .. ".bin")) emu.stop(1) return end
        g:write(ob); g:close()
      else
    ...
    if (sf == 118 or sf == 132 or sf == 145 or sf == 175) and shots < 4 then
      ...
      if not f then print("probe_sms_stagejump.lua: cannot open " .. (ENV.TRACE .. "saturn/stagejump_" .. TAG .. "_" .. sf .. ".png")) emu.stop(1) return end
      ...
      if not cf then print("probe_sms_stagejump.lua: cannot open " .. (ENV.TRACE .. "saturn/stagejump_" .. TAG .. "_cgram" .. sf .. ".bin")) emu.stop(1) return end
