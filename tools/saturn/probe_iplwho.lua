...
-- probe_iplwho.lua — boot a VS match (CHAR/CHAR2 poked at select) and log each
-- unique PC writing the APU data port $2141 (who feeds the IPL, plus the dp00
-- pointer in use), then dump ARAM mid-match.
