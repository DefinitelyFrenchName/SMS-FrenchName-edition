...
emu.addMemoryCallback(function()
  if needLoad then local f = io.open(TRACE.."venus_vs_jupiter_clean.mss","rb") if not f then print("probe_ppu.lua: cannot open " .. (TRACE.."venus_vs_jupiter_clean.mss")) emu.stop(1) return end
...
emu.addEventCallback(function()
  ...
  if t==30 then
    ...
    if not log then print("probe_ppu.lua: cannot open " .. (TRACE.."probe_ppu.txt")) emu.stop(1) return end
